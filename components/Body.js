...
const Body = () => {
  ...
  const fetchData = async () => {
    const data = await fetch(
      "https://crossorigin.me/https://www.swiggy.com/dapi/restaurants/list/v5?lat=28.4594965&lng=77.0266383&is-seo-homepage-enabled=true&page_type=DESKTOP_WEB_LISTING"
    );
